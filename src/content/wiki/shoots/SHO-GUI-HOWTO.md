...
If you live in the UK, check out the [UKPSA website](https://outdoortechnica.com/how-to-start-shooting-action-air-ipsc/).
...
no handgun limitation

no handgun limitation

must be 1911 genre design (single action hammer)

must represent a handgun from the production list
...
max barrel length 127 mm

**Maximum Magazine Length**

170mm

<= 20mm from end of handgun

<= 20mm from end of handgun

allowances as long as negligible weight
...
**Equipment Belt Position**

anywhere around torso
...
**Compensators, Porting, Ports, Flash Suppressor**

allowed

slides and barrels may be ported only
